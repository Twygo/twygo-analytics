...
O arquivo se chama `Twygo-Analytics-Setup-1.0.5.exe` (cerca de 170 MB).
...
2. O Windows pode exibir um aviso de **"aplicativo não reconhecido"** — isso
   ...
   **Mais informações → Executar assim mesmo**.
   ...
   ```powershell
   Get-FileHash .\Twygo-Analytics-Setup-1.0.5.exe -Algorithm SHA256
   ```
...
`Twygo-Analytics-Acme-1.0.5.exe`.
...
É o caso do arquivo `Twygo-Analytics-Setup-1.0.5.exe`. Na primeira abertura ele
